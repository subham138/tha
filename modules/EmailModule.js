  ...
  return new Promise(async (resolve, reject) => {
    ...
    var mailOptions = {
      ...
      html:
        ...
        '<h2 style="font-size:18px; font-weight:700; font-family:Arial, Helvetica, sans-serif;">Hi ' +
        con_name +
        ",</h2>" +
        ...
        '<p style="padding-bottom:15px; margin:0;"><img src="' +
        api_url +
        img +
        '" width="128" height="128" alt=""></p>' +
  ...
  return new Promise(async (resolve, reject) => {
    ...
    var mailOptions = {
      ...
      html:
        ...
        res_name +
        '" readonly style="height: 22px; padding: 5px; font-size: 1rem; font-weight: 400; line-height: 1.5; color: #495057; background-color: #fff; background-clip: padding-box; border: 1px solid #ced4da; border-radius: .25rem; transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out; margin: 0 !important;"><br><br>' +
        '<label for="contact">Name of person:</label>' +
        '<input type="text" id="contact" name="contact" value="' +
        con_name +
        '" readonly style="height: 22px;padding: 5px;font-size: 1rem;font-weight: 400;line-height: 1.5;color: #495057;background-color: #fff;background-clip: padding-box;border: 1px solid #ced4da;border-radius: .25rem;transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;margin: 0 !important;"><br>' +
        ...
        "<br>" +
        "Description<br> " +
        '<textarea rows="6" cols="60" maxlength="50" readonly style="height:120px; width: 100%;padding: .375rem .75rem;font-size: 1rem; box-sizing: border-box;font-weight: 400;line-height: 1.5;color: #495057;background-color: #fff;background-clip: padding-box;border: 1px solid #ced4da;border-radius: .25rem;transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;margin:15px 0 20px 0 !important;">' +
        desc +
        "</textarea>" +
        "</form>" +
        "</td>" +
...
const OrderEmail = (data) => {
  return new Promise(async (resolve, reject) => {
    ...
    body = body
      .split("#[address]")
      .join(data.Address1 + ", " + data.cityState + ", " + country_name);
  ...
  return new Promise(async (resolve, reject) => {
    ...
    var mailOptions = {
      ...
      html:
        ...
        '<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:400; line-height:22px; padding-bottom:15px; margin:0;"><b>UserName:</b> ' +
        email_id +
        "<br><b>Password:</b> " +
        password +
        "</p>" +
        ...
        '<a href="' +
        client_url +
        '/login" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 600;' +
    ...
    data.msg.forEach(async (dt) => {
      ...
      var mailOptions = {
        ...
        html:
          ...
          '<table width="100%" border="0" cellspacing="0" cellpadding="0">' +
          "<tr>" +
          '<td align="left" valign="top" class="logoArea" style="padding:0 0 25px 0; text-align:center;"><img src="https://lagunaapi.shoplocal-lagunabeach.com/' +
          logo +
          '" width="402" height="300" alt="" style="max-width:190px; width:100%; height:auto; margin:0 auto;"></td>' +
          "</tr>" +
          "<tr>" +
          '<td align="left" valign="top">' +
  ...
  return new Promise(async (resolve, reject) => {
    ...
    var mailOptions = {
      ...
      html:
        ...
        '<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:400; line-height:22px; padding-bottom:15px; margin:0;"><a href="' +
        client_url +
        "payment/" +
        en_dt +
        '/1">CLICK HERE</a></p>' +
  ...
  return new Promise(async (resolve, reject) => {
    ...
    var mailOptions = {
      ...
      html:
        ...
        email_name +
        ",</h2>" +
        '<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:400; line-height:22px; padding-bottom:15px; margin:0;">A restaurent, ' +
        res_name +
        " has raised some issues regarding custom menu. Issues are mentioned below.</p>" +
        '<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:400; line-height:22px; padding-bottom:15px; margin:0;">' +
        issue +
        "</p>" +
